...
time.sleep(1)
driver.get("https://pos-app.macomal.com/size-master")
driver.find_element(By.XPATH,"//input[@id='sizeName']").send_keys("six")
time.sleep(1)
driver.find_element(By.ID,"sizeSymbol").send_keys('nike')
time.sleep(2)
